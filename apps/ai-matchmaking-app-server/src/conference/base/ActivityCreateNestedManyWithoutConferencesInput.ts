...
@InputType()
class ActivityCreateNestedManyWithoutConferencesInput {
...
export { ActivityCreateNestedManyWithoutConferencesInput as ActivityCreateNestedManyWithoutConferencesInput };
