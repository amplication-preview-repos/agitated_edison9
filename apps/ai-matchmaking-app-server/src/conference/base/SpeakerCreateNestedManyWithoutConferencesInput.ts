...
@InputType()
class SpeakerCreateNestedManyWithoutConferencesInput {
...
export { SpeakerCreateNestedManyWithoutConferencesInput as SpeakerCreateNestedManyWithoutConferencesInput };
